...
router.post("/", (0, auth_1.default)("ADMIN"), profile_controller_1.ProfileControllers.createProfile);
...
router.patch("/:id", (0, auth_1.default)("ADMIN"), profile_controller_1.ProfileControllers.updateProfile);
